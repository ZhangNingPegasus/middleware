...
public class PermissionInterceptor extends AbstractInterceptor {
    ...
    public PermissionInterceptor(final PluginAdapter pluginAdapter,
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        return this.invokePermission(invocation, permissionAnnotation);
    }
    ...
    private Object invokePermission(MethodInvocation invocation, Permission permissionAnnotation) throws Throwable {
        ...
        LOG.info("权限拦截：Permission [name={}, description={}, proxyType={}, proxiedClass={}, method={}, parameterTypesValue={}]", name, description, proxyType, proxiedClassName, methodName, parameterTypesValue);
