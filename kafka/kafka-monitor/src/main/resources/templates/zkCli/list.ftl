<@compress single_line=true>
    ...
    <div class="layui-fluid">
        <div class="layui-card">
            <div class="layui-card-body">
                <div id="zkcli" class="terminal" style="height: 780px">
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        layui.config({base: '../../..${ctx}/layuiadmin/'}).extend({index: 'lib/index'}).use(['index', 'table'], function () {
            const height = 780, admin = layui.admin;
            ...
            function execute(command, term) {
                ...
                if (type !== '') {
                    admin.postQuiet('execute', {'command': command, 'type': type}, function (res) {
            ...
            admin.postQuiet('zkInfo', {}, function (data) {
