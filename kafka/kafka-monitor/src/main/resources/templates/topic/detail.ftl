<@compress single_line=true>
    ...
    <script>
        layui.config({base: '../../..${ctx}/layuiadmin/'}).extend({index: 'lib/index'}).use(['index', 'table', 'carousel', 'echarts'], function () {
            ...
            table.render({
                elem: '#gridLogSize',
                url: 'listTopicDetailLogSize?topicName=${topicName}',
                method: 'post',
                cellMinWidth: 80,
                page: false,
                limit: 99999999,
                ...
                text: {none: '暂无相关数据'},
                cols: [[
                    {field: "day0LogSize", title: '今天消息数量', templet: '#colDay0LogSize', width: 207},
                    {field: "day1LogSize", title: '昨天消息数量', templet: '#colDay1LogSize', width: 207},
                    {field: "day2LogSize", title: '前天消息数量', templet: '#colDay2LogSize', width: 207},
                    {field: "day3LogSize", title: '前3天消息数量', templet: '#colDay3LogSize', width: 206},
                    {field: "day4LogSize", title: '前4天消息数量', templet: '#colDay4LogSize', width: 206},
                    {field: "day5LogSize", title: '前5天消息数量', templet: '#colDay5LogSize', width: 206},
                    {field: "day6LogSize", title: '前6天消息数量', templet: '#colDay6LogSize', width: 206}
                ]],
            });
            ...
            table.render({
                ...
                cols: [[
                    ...
                    {field: "strLeader", title: '分区Leader', templet: '#colLeader', width: 201},
                    {field: "strReplicas", title: '分区副本', templet: '#colReplicas', width: 538},
                    {field: "strIsr", title: '同步副本', templet: '#colIsr', width: 538}
                ]],
                done: function (res) {
                    let logSize = 0;
