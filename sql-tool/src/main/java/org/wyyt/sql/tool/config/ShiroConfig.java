...
import org.wyyt.sql.tool.shiro.AuthRealm;
import org.wyyt.sql.tool.shiro.CredentialsMatcher;
...
public class ShiroConfig {
    ...
    public SimpleCookie sessionIdCookie() {
        // 这个参数是cookie的名称
        final SimpleCookie simpleCookie = new SimpleCookie("sidSqlTool");
        // setcookie的httponly属性如果设为true的话，会增加对xss防护的安全系数。它有以下特点：
        // 只能通过http访问，javascript无法访问
        // 防止xss读取cookie
        simpleCookie.setHttpOnly(true);
        simpleCookie.setPath("/sql_tool");
