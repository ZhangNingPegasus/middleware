            ...
            <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline" style="width:500px">
                        <input type="text" name="name" placeholder="请输入配置项名称" autocomplete="off"
                               class="layui-input">
                    </div>
        ...
        layui.config({base: '../../..${ctx}/layuiadmin/'}).extend({index: 'lib/index'}).use(['index', 'table'], function () {
            ...
            table.render({
                ...
                cols: [[
                    ...
                    {field: 'value', title: '值'},
                    {field: 'description', title: '描述信息', width: 400},
                    {
                        field: 'rowCreateTime',
                        title: '创建时间',
            ...
            table.on('tool(grid)', function (obj) {
                ...
                if (obj.event === 'edit') {
                    layer.open({
                        type: 2,
                        title: '<i class="layui-icon layui-icon-edit" style="color: #1E9FFF;"></i>&nbsp;编辑参数',
